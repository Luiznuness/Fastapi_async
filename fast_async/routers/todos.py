...
from fast_async.models import Todo, User
...
from fast_async.security import get_current_user
...
async def patch_todo(
    ...
    for chave, valor in todo.model_dump(exclude_unset=True).items():
        setattr(db_todo, chave, valor)
