...
from fast_async.models import User, table_registry
from fast_async.security import get_password_hash
from fast_async.settings import Settings
...
def token(client, user):
    ...
    return resultado.json()['token_access']
